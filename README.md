...
- aspen2-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- aspen2-ui: main application module, development time
- aspen2-production: module that produces a production mode WAR for deployment
